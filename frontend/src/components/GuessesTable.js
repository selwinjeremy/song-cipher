...
const GuessesTable = ({ guesses }) => {
  ...
  const columnHeaders = [
    ...
    { name: "Released", helpText: <>Red: Year is off by atleast 2 Years <br /> Yellow: Year is off by 1 Year <br /> Green: Correct Year <br /> Up Arrow: The Song to Guess is more recent <br /> Down Arrow: The Song to Guess is older</> },
    { name: "Length", helpText: <>Red: Song Length is off by atleast 30 seconds <br /> Yellow: Song Length is less than 30 seconds off <br /> Green: Correct Song Length <br /> Up Arrow: The Song to Guess is longer <br /> Down Arrow: The Song to Guess is shorter</> },
          ...
          <TableHead>
            <TableRow style={{ backgroundColor: "#282828" }}>
              {columnHeaders.map(({ name, helpText }) => (
                <TableCell key={name} style={{ color: "white", fontWeight: "bold", fontSize: "14px", padding: "14px" }}>
                  {name}
                  <Tooltip title={helpText} arrow>
                    <InfoOutlined fontSize="small" style={{ marginLeft: 5, cursor: "pointer", color: "white" }} />
                  </Tooltip>
                </TableCell>
              ))}
            </TableRow>
